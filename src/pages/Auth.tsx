...
function OAuthButton({
  ...
  return (
    <Button
      ...
      variant="outline"
      className={cn(
        'h-11 w-full justify-between rounded-xl border bg-white/70 font-mono text-slate-700 shadow-sm transition-all hover:-translate-y-0.5 hover:bg-white hover:text-slate-900 dark:bg-slate-900/75 dark:text-slate-100 dark:hover:bg-slate-900',
