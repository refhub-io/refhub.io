...
const VaultSettingsPage: React.FC = () => {
  ...
  useEffect(() => {
    if (vault?.id) {
      console.log('[VaultSettings] Vault loaded:', vault);
      setVisibility((vault as any).visibility || 'private');
      loadShares();
    }
  }, [vault]);
  ...
  const handleVisibilityChange = async (newVisibility: VaultVisibility) => {
    ...
    setError(null);
    try {
      console.log('[VaultSettings] Updating visibility:', { vaultId: vault.id, newVisibility, currentVisibility: visibility });
      ...
      console.log('[VaultSettings] Update result:', { data, error });
      ...
      console.log('[VaultSettings] Update successful, visibility changed to:', data.visibility);
      ...
      console.error('[VaultSettings] Update error:', err);
