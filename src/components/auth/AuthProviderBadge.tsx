  ...
  return (
    <span
      className={cn(
        ...
        'border-pink-500/30 bg-gradient-to-r from-fuchsia-500/10 via-pink-500/10 to-violet-500/10 text-fuchsia-700 dark:border-fuchsia-400/35 dark:bg-fuchsia-500/15 dark:text-fuchsia-100',
        className
      )}
    >
      last_used
