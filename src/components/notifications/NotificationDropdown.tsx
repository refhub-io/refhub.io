...
export function NotificationDropdown() {
  ...
  const content = (
    <>
      <div className="flex items-center justify-between p-3 pr-10 border-b border-border">
  ...
  if (isMobile) {
    return (
      <Sheet open={open} onOpenChange={setOpen}>
        ...
        <SheetContent
          side="bottom"
          className="p-0 border-t-2 bg-card/95 backdrop-blur-xl rounded-t-xl max-h-[70vh] flex flex-col"
        >
          {content}
        </SheetContent>
      </Sheet>
