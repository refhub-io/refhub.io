...
describe('PublicVaultSectionsView', () => {
  it('groups papers by section, in section then paper order, and excludes unsectioned papers', () => {
    ...
    expect(screen.getByText('starter_papers')).toBeInTheDocument();
  ...
  it('shows a star and note for a featured paper', () => {
